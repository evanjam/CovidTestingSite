...
//source: https://code.tutsplus.com/tutorials/create-a-php-login-form--cms-33261
	...
	if (isset($_POST['register'])) {
		...
		echo "registration form triggered. you entered:<br>username:$username<br>password:$password<br>password hash:$password_hash<br>";
...
//		if ($query->rowCount() == 0) {
			...
			if ($result) {
				...
				echo '<p class="error">registration error you suck</p>';
			}
//		}
	}
?>